...
const HowItWorksSection = () => {
  ...
  return (
    <section className=" w-[90%] mt-[388px] lg:w-[75%]">
      ...
      <div className={`flex flex-col-reverse  lg:flex lg:${i18n.language === "Ar" ? "flex-row-reverse" : "flex-row"} lg:justify-between lg:items-center`} id="howitworks">

        <div className="mt-20 w-full flex flex-col items-center justify-center">
            <div className={`flex flex-col gap-5 justify-center ${i18n.language === "Ar" ? "items-end" : "items-start"} `}>
                <div className={`flex ${i18n.language === "Ar" ? "flex-row-reverse" : "flex-row"} gap-5`}>
      ...
      <div className={`flex ${i18n.language === "Ar" ? "flex-row-reverse" : "flex-row"} items-center justify-center gap-5 mt-10`}>
